...
export class AddMediaRemovalRequest1785865019657 implements MigrationInterface {
  name = 'AddMediaRemovalRequest1785865019657';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "media_removal_request" ("id" SERIAL NOT NULL, "status" integer NOT NULL, "is4k" boolean NOT NULL DEFAULT false, "type" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "mediaId" integer, "requestedById" integer, "modifiedById" integer, CONSTRAINT "PK_2e934c02b7a727d262b9c0adc36" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
