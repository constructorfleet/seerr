 ...
 * safe component lookup anyway. An unrecognised name gets the generic puzzle
 * piece, which is a fine outcome for a cosmetic field.
 */
const PANEL_ICONS: Record<string, ComponentType<SVGProps<SVGSVGElement>>> = {
  BellIcon,
  BoltIcon,
  BookOpenIcon,
  ChartBarIcon,
  ...
  return (
    <>
      {sidebarPanels.map((panel) => {
        const Icon = PANEL_ICONS[panel.sidebar?.icon ?? ''] ?? PuzzlePieceIcon;
